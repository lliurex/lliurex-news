...
export default Service.extend({
    ...
    maintenanceAlert() {
        this.notifications.showAlert(
            this.intl.t('Sorry, Ghost is currently undergoing maintenance, please wait a moment then try again.'),
    ...
    requireUpgrade() {
        ...
        this.notifications.showAlert(
            this.intl.t('Ghost has been upgraded, please copy any unsaved data and refresh the page to continue.'),
